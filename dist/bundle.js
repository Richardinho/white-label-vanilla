...
/***/ "./js/build-criteria-from-query-string.js":
/*!************************************************!*\
  !*** ./js/build-criteria-from-query-string.js ***!
  \************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nconst Injector           = __webpack_require__(/*! Diogenes */ \"./node_modules/Diogenes/lib/injector.js\");\nconst SelectionBox       = __webpack_require__(/*! selection-box */ \"./node_modules/selection-box/build/selection-box.js\");\nconst Router             = __webpack_require__(/*! ./router */ \"./js/router.js\");\nconst delegate           = __webpack_require__(/*! ./delegate */ \"./js/delegate.js\");\nconst Bootstrap          = __webpack_require__(/*! ./bootstrap */ \"./js/bootstrap.js\");\nconst HomeController     = __webpack_require__(/*! ./home-controller */ \"./js/home-controller.js\");\nconst emperorController  = __webpack_require__(/*! ./emperor-controller */ \"./js/emperor-controller.js\");\nconst createEmperorModel = __webpack_require__(/*! ./create-emperor-model */ \"./js/create-emperor-model.js\");\nconst handleInternalLink = __webpack_require__(/*! ./handle-internal-link */ \"./js/handle-internal-link.js\");\nconst html               = __webpack_require__(/*! ./html */ \"./js/html.js\");\nconst LoadingPanel       = __webpack_require__(/*! ./loading-panel */ \"./js/loading-panel.js\");\nconst DataService        = __webpack_require__(/*! ./data-service */ \"./js/data-service.js\");\nconst renderAside        = __webpack_require__(/*! ./render-aside */ \"./js/render-aside.js\");\nconst renderResults      = __webpack_require__(/*! ./render-results */ \"./js/render-results.js\");\nconst resultTemplate     = __webpack_require__(/*! ./templates/result */ \"./js/templates/result.js\");\nconst asideTemplate      = __webpack_require__(/*! ./templates/aside */ \"./js/templates/aside.js\");\nconst footerTemplate     = __webpack_require__(/*! ./templates/footer */ \"./js/templates/footer.js\");\nconst bannerTemplate     = __webpack_require__(/*! ./templates/banner */ \"./js/templates/banner.js\");\nconst paginationTemplate = __webpack_require__(/*! ./templates/pagination */ \"./js/templates/pagination.js\");\nconst emperorTemplate    = __webpack_require__(/*! ./templates/emperor */ \"./js/templates/emperor.js\");\nconst handleRequest      = __webpack_require__(/*! ./handle-request */ \"./js/handle-request.js\");\nconst buildCriteriaFromQueryString = __webpack_require__(/*! ./build-criteria-from-query-string */ \"./js/build-criteria-from-query-string.js\");\nconst buildQueryStringFromCriteria = __webpack_require__(/*! ./build-query-string-from-criteria */ \"./js/build-query-string-from-criteria.js\");\n\nconst app = document.getElementById('app');\nconst injector = new Injector();\n\ninjector.register('router',             Router,             Injector.CACHE_INSTANCE);\ninjector.register('dataService',        DataService,        Injector.CACHE_INSTANCE);\ninjector.register('HomeController',     HomeController,     Injector.INSTANCE, [app]);\ninjector.register('emperorController',  emperorController,  Injector.FACTORY_FUNCTION, [app]);\ninjector.register('createEmperorModel', createEmperorModel, Injector.FACTORY_FUNCTION);\ninjector.register('handleInternalLink', handleInternalLink, Injector.FACTORY_FUNCTION);\ninjector.register('html',               html,               Injector.FACTORY_FUNCTION);\ninjector.register('loadingPanel',       LoadingPanel,       Injector.INSTANCE);\ninjector.register('delegate',           delegate,           Injector.VALUE);\ninjector.register('renderAside',        renderAside,        Injector.FACTORY_FUNCTION);\ninjector.register('renderResults',      renderResults,      Injector.FACTORY_FUNCTION);\ninjector.register('SelectionBox',       SelectionBox,       Injector.VALUE);\ninjector.register('bootstrap',          Bootstrap,          Injector.INSTANCE);\ninjector.register('resultTemplate',     resultTemplate,     Injector.VALUE);\ninjector.register('asideTemplate',      asideTemplate,      Injector.VALUE);\ninjector.register('footerTemplate',     footerTemplate,     Injector.VALUE);\ninjector.register('bannerTemplate',     bannerTemplate,     Injector.VALUE);\ninjector.register('paginationTemplate', paginationTemplate, Injector.VALUE);\ninjector.register('emperorTemplate',    emperorTemplate,    Injector.VALUE);\ninjector.register('handleRequest',      handleRequest,      Injector.FACTORY_FUNCTION);\n\ninjector.register('buildCriteriaFromQueryString',\n  buildCriteriaFromQueryString,\n  Injector.VALUE);\n\ninjector.register('buildQueryStringFromCriteria',\n  buildQueryStringFromCriteria,\n  Injector.VALUE);\n\ninjector.register('injector',           injector,           Injector.VALUE);\n\ninjector.start('bootstrap', function (bootstrap) {\n\n\tbootstrap.start();\n\n});\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n//# sourceURL=webpack:///./js/main.js?");
...
eval("module.exports = function (data) { return (function anonymous() {\nvar r=[];r.push(\"<div class=\\\"banner\\\"><h1><a href=\\\"\\\">      Emperors of Rome</a></h1></div>\");return r.join(\"\");\n}).apply(data); };\n\n//# sourceURL=webpack:///./js/templates/banner.js?");
